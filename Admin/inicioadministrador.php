...
================================================== -->
				...
				<div class="col-md-7">
					<div class="card-block">
						...
						<h4 class="card-text">
									...
									<a href="modDB/eliminaplatillo.php?id=<?php echo $mostrar['ID']?>" class="btn btn-danger">Eliminar Platillo</a>
	...
	<div class="card-columns listfeaturedtag">
		...
		while($mostrar=mysqli_fetch_array($result)){
            ...
            $sql2="SELECT * from menu where nombre='$nombre'";
		...
		<div class="card">
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card-block">
						<h2 class="card-title"><?php echo $mostrar['nombre_cliente'] ?> <?php echo $mostrar['apellido_paterno'] ?> <?php echo $mostrar['apellido_materno']?></a></h2>
						<h4 class="card-text">
								ID del pedido: <?php echo $mostrar['ID']?></br>
								Nombre del platillo: <?php echo $mostrar['nombre'] ?></br>
				...
				<div class="col-md-5">
					<div class="card-block">
						...
						<h4 class="card-text">
                                        ...
                                        <a href="modDB/eliminado.php?nombre=<?php echo $mostrar['ID']?>" class="btn btn-danger">Eliminar la cuenta del cliente</a>
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
				...
				<div class="col-md-5">
					<div class="card-block">
						...
						<h4 class="card-text">
                                        ...
                                        Direccion: <?php echo $mostrar['direccion'] ?><br/>
                                        Correo: <?php echo $mostrar['correo'] ?>. <br/>
                                        <a href="modDB/eliminarempleados.php?nombre=<?php echo $mostrar['ID']?>" class="btn btn-danger">Eliminar empleado</a>
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
